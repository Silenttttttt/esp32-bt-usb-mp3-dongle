 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdc, 0x05 /* = 0x05dc = shared vendor-class PID */
...
#define USB_CFG_DEVICE_NAME     'F','a','k','e',' ','M','S','C',' ','T','e','s','t'
 ...
 */
#define USB_CFG_DEVICE_CLASS        0    /* deferred to interface (Mass Storage) */
#define USB_CFG_DEVICE_SUBCLASS     0
/* See USB specification if you want to conform to an existing device class.
 * Class 0xff is "vendor specific".
 */
#define USB_CFG_INTERFACE_CLASS     0x08     /* Mass Storage class */
#define USB_CFG_INTERFACE_SUBCLASS  0x06     /* SCSI transparent command set */
#define USB_CFG_INTERFACE_PROTOCOL  0x50     /* Bulk-Only Transport */
